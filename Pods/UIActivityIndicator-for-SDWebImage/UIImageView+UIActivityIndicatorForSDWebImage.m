...
@property(nonatomic,retain)SCSkypeActivityIndicatorView *loaderView;
...
- (void)addActivityIndicatorWithStyle:(UIActivityIndicatorViewStyle)activityStyle {
    ...
    if (!self.activityIndicator) {
       ...
       // self.activityIndicator.color=[UIColor colorWithRed:62.0/255.0 green:80.0/255.0 blue:238.0/255.0 alpha:1.0];
